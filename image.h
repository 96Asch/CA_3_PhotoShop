...
/* The functions below provide three simple vector operations (add, mult, mults)
 * Their current implementation is far from ideal. On the CPU we would
 * normally use SIMD instructions for these, while on the GPU you could
...
/* Multiplication: muliply `a1` and `a2` component-wise and copy the result to `v` */
